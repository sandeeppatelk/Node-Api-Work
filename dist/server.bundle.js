...
/***/ function(module, exports, __webpack_require__) {
	...
	var _en3 = __webpack_require__(28);
	...
	var _fr3 = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostCreateWidget = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sarthi = __webpack_require__(39);
	
	var SarthiController = _interopRequireWildcard(_sarthi);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostListItem = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getSarthis = getSarthis;
	exports.addSarthi = addSarthi;
	exports.getSarthi = getSarthi;
	exports.deleteSarthi = deleteSarthi;
	
	var _sarthi = __webpack_require__(41);
	
	var _sarthi2 = _interopRequireDefault(_sarthi);
	 ...
	 * @returns void
	 */
	function getSarthis(req, res) {
	  _sarthi2.default.find(function (err, sarthis) {
	    if (err) {
	      return res.status(500).send(err);
	    }
	
	    return res.jsonp({ sarthis: sarthis });
	  });
	}
	 ...
	 * @returns void
	 */
	function getSarthi(req, res) {
	  _sarthi2.default.findOne({ _id: req.params.id }).exec(function (err) {
	    var sarthi = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
	
	    if (err) {
	      return res.status(500).send(err);
	    }
	
	    return res.jsonp({ sarthi: sarthi });
	  });
	}
	 ...
	 * @returns void
	 */
	function deleteSarthi(req, res) {
	  _sarthi2.default.findOne({ _id: req.params.id }).exec(function (err, sarthis) {
	    if (err) {
	      return res.status(500).send(err);
	    }
	
	    sarthis.remove(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getVehicles(req, res) {
	  _vehicle2.default.find(function (err, vehicles) {
	    if (err) {
	      return res.status(500).send(err);
	    }
	    return res.jsonp({ vehicles: vehicles });
	  });
	}
	...
	function addVehicle(req, res) {
	  ...
	  var newVehicle = new _vehicle2.default(req.body.vehicle);
	...
	function getVehicle(req, res) {
	  _vehicle2.default.findOne({ _id: req.params.id }).exec(function (err, vehicle) {
	    if (err) {
	      return res.status(500).send(err);
	    }
	
	    return res.jsonp({ vehicle: vehicle });
	  });
	}
	...
	function deleteVehicle(req, res) {
	  _vehicle2.default.findOne({ _id: req.params.id }).exec(function (err, vehicles) {
	    if (err) {
	      return res.status(500).send(err);
	    }
	
	    vehicles.remove(function () {
	      return res.status(200).end();
	    });
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _mongoose2.default.model('Sarthi', vehicleSchema);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vehicles = __webpack_require__(22);
	
	var _vehicles2 = _interopRequireDefault(_vehicles);
	
	var _sarthi = __webpack_require__(21);
	...
	app.use('/api', _sarthi2.default);
	app.use('/api', _vehicles2.default);
